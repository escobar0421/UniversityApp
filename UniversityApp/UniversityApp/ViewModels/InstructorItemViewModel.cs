   ...
   public class InstructorItemViewModel : InstructorDTO
    {
        ...
        async Task DeleteInstructor()
        {
            ...
            var instructorViewModel = InstructorViewModel.GetInstance();
            var instructorDeleted = instructorViewModel.AllInstructor.FirstOrDefault(x => x.ID == this.ID);
            instructorViewModel.AllInstructor.Remove(instructorDeleted);
            instructorViewModel.GetType();
        }
    }
}
